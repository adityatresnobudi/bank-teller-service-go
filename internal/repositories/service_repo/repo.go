...
type Repository interface {
	...
	GetOneByName(ctx context.Context, name string) (*entity.Service, errs.MessageErr)
	Create(ctx context.Context, service entity.Service) errs.MessageErr
	UpdateById(ctx context.Context, service entity.Service) (*entity.Service, errs.MessageErr)
